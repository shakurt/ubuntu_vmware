...
![Step 2: New Virtual Machine wizard (Typical configuration)](/images/ubuntu/step1.png)
...
![Step 3: Select installer disc image (ISO) screen](/images/ubuntu/step2.png)

![Step 3: Guest OS detection summary after ISO selection](/images/ubuntu/step3.png)
...
![Step 4: VMware Easy Install user information form](/images/ubuntu/step4.png)
...
![Step 5: Virtual machine name and location settings](/images/ubuntu/step5.png)
...
![Step 6: Specify disk capacity and storage layout](/images/ubuntu/step6.png)
...
![Step 7: Customize hardware dialog (memory, CPU, network)](/images/ubuntu/step7.png)
